		...
		Steps: []resource.TestStep{
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(td.ResourceName, "state_code", emergencyAddressTestResource.StateCode),
			...
			// Update and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(td.ResourceName, "state_code", updateEmergencyAddressTestResource.StateCode),
