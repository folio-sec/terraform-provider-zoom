...
func (c *PhoneAutoReceptionistCrud) Read(ctx context.Context, autoReceptionistID string) (*PhoneAutoReceptionistModel, error) {
	...
	return &PhoneAutoReceptionistModel{
...
func (c *PhoneAutoReceptionistCrud) Create(ctx context.Context, dto PhoneAutoReceptionistCreateDto) (*PhoneAutoReceptionistCreatedDto, error) {
...
func (c *PhoneAutoReceptionistCrud) Update(ctx context.Context, dto PhoneAutoReceptionistUpdateDto) error {
